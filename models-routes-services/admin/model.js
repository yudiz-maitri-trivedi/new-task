...
const { eAdminType, eAdminPermission, eAdminPermissionType, eAdminStatus } = require('../../enum')
...
const Admin = new mongoose.Schema({
  ...
  eType: { type: String, enum: eAdminType.values, required: true },
  aPermissions: [{ // Deprecated field, not in used
    eKey: { type: String, enum: eAdminPermission.values },
    eType: { type: String, enum: eAdminPermissionType.values } // R = READ W = WRITE N = NONE
  }],
  ...
  eStatus: { type: String, enum: eAdminStatus.values, default: eAdminStatus.default },
  aJwtTokens: [{
    sToken: { type: String },
